...
function! statusline#lintinfo#Jump(direction, wrap) abort
...
" Deprecated since it was called twice in statusline on every update.
function! statusline#lintinfo#Count() abort
    let l:bufnr = bufnr('%')
    let l:loclist = getloclist(0)
